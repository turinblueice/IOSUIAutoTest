...
class TopicDetailActivity(base_frame_view.BaseFrameView):
    ...
    def __init__(self, parent):
        ...
        self._scroll_view = window.FrameLayout(self.parent, id='com.jiuyan.infashion:id/drag_layout')
    ...
    def subscription_button(self):
        ...
        return window.FrameLayout(self.parent, id=id_)
    ...
    def share_pop_button(self):
        """
            Summary:
                遮罩分享按钮
        """
        return static_text.TextView(self.parent, uiautomator='new UiSelector().text("分享")')
    ...
    def undo_subscribe_button(self):
        """
            Sumary:
                取消订阅按钮
        """
        return static_text.TextView(self.parent, uiautomator='new UiSelector().text("取消订阅")')
    ...
    def cancel_pop_button(self):
        """
            Summary:
                取消按钮
        """
        return static_text.TextView(self.parent, id='com.jiuyan.infashion:id/tv_bottom_menu_cancel')
    ...
    def wait_for_hotest_container(self):
        ...
        rec_ = action_sheet.RecyclerView(self.parent, id=id_)
...
class HotestContainer(base_frame_view.BaseFrameView):
    ...
    def like_button(self):
        ...
        return static_text.TextView(self._layout_view, id=id_)
    ...
    def liker_avatar_list(self):
        ...
        liker_list = image.ImageViewList(layout, type='android.widget.ImageView').image_list[:-1]
        return liker_list
    ...
    def tap_to_submit_comment(self):
        ...
        if self.base_parent.wait_activity(windows.ActivityNames.FRIEND_PHOTO_DETAIL, 10):
...
class NewestPhotoAlbum(base_frame_view.BaseFrameView):
    ...
    def like_icon(self):
        ...
        return image.ImageView(self._layout_view, id=id_)
