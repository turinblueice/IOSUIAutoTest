...
class AddFriendActivity(base_frame_view.BaseFrameView):
    ...
    def star_talent_item(self):
        """
            Summary:
                明星达人添加按钮
        """
        return static_text.TextView(self.parent, uiautomator='new UiSelector().textContains(\"明星达人\")')
    ...
    def tap_back_button(self):
        ...
        if self.wait_activity(windows.ActivityNames.IN_MAIN, 10):
    ...
    def tap_start_talent_item(self):
        ...
        view_ = table_group.ListView(self.parent, id='com.jiuyan.infashion:id/usercenter_follow_friends_list')
