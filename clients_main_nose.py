...
from multi_clients_manager import appium_manager
from multi_clients_manager import device_configuration
...
if __name__ == '__main__':
    ...
    if test_support_list:
        ...
        try:
            device_queue = multi_clients_base_test.AppiumDevicesPortsInfo.device_queue
            ports_queue = multi_clients_base_test.AppiumDevicesPortsInfo.ports_queue

            map(device_queue.put, device_configuration.DeviceConfiguration().get_ios_devices())
