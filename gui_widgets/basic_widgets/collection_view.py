...
class UIACollectionView(base_frame_view.BaseFrameView):
    """
        Summary:
            UIAButton类型
    """
    def __init__(self, parent, view=None, **kwargs):
        super(UIACollectionView, self).__init__(parent)
...
class UIACollectionViewList(base_frame_view.BaseFrameView):
    """

    """
    def __init__(self, parent, **kwargs):
        super(UIACollectionViewList, self).__init__(parent)
        self.__view_list = self.find_elements(**kwargs)

    @property
    def cell_list(self):

        return [UIACollectionView(view.parent, view) for view in self.__view_list]
