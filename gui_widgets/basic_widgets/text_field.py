...
class UIATextField(base_frame_view.BaseFrameView):
    """

    """
    def __init__(self, parent, edit_text=None, **kwargs):
        super(UIATextField, self).__init__(parent)
...
class UIATextFieldList(base_frame_view.BaseFrameView):
    """

    """
    def __init__(self, parent, **kwargs):
        super(UIATextFieldList, self).__init__(parent)
        self.__edit_text_list = self.find_elements(**kwargs)

    @property
    def text_field_list(self):

        if self.__edit_text_list:
            return [UIATextField(field.parent, field) for field in self.__edit_text_list]
        return None
