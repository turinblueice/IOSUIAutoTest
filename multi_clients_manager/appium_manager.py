...
class AppiumManager(object):
    ...
    def start_appium_by_default(self, delay=3):
        ...
        cmd_str = model.config_parser.get('cmd', 'start_default_appium_cmd_'+self.postfix)
    ...
    def start_appium(self, port=None, bootstrap_port=None, delay=3):
        ...
        try:
            ...
            cmd_str = model.config_parser.get('cmd', 'start_appium_cmd_'+self.postfix)
    ...
    def find_appium_process(self):
        ...
        pid_list = []
        cmd_str = model.config_parser.get('cmd', 'find_appium_cmd_'+self.postfix)
    ...
    def kill_appium_process_by_pid(self, pid, cmd_str=None):
        ...
        cmd_str = cmd_str or model.config_parser.get('cmd',
    ...
    def kill_appium_processes(self, pid_list=None):
        ...
        if pid_list is not None:
            ...
            cmd_str = model.config_parser.get('cmd', 'kill_appiums_cmd_'+self.postfix)
